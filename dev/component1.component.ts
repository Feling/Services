...
export class Component1Component {
    ...
    constructor(private _loggingService:LoggingService, private _calculatorService:CalculatorService, private _dataServise:DataService) {
    }
    ...
    onGetData() {
        this.data = this._dataServise.getRandomString();
    }

    onInsert(value:string) {
        this._dataServise.insert(value);
    }
}